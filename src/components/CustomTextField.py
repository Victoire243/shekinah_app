...
class CustomTextField(ft.TextField):
    def __init__(
        ...
        capitalization=None,
        autocorrect=None,
        enable_suggestions=None,
        smart_dashes_type=None,
        smart_quotes_type=None,
        show_cursor=None,
        cursor_color=None,
        cursor_error_color=None,
        cursor_width=None,
        cursor_height=None,
        cursor_radius=None,
        ...
        enable_ime_personalized_learning=None,
        can_request_focus=None,
        ignore_pointers=None,
        enable_scribble=None,
        animate_cursor_opacity=None,
        always_call_on_tap=None,
        scroll_padding=None,
        clip_behavior=None,
        ...
        self.bgcolor = "white"
        self.content_padding = ft.padding.symmetric(vertical=2.5, horizontal=10)
