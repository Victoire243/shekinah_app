...
def generer_facture(list_medicaments, prix_total, reduction, charges_connexes):
    ...
    logo_path = "assets/images/logo.png"  # Remplace par le chemin de ton logo
    ...
    c.setFont("Helvetica", 12)
    c.drawString(marge_gauche, y_position, "Client Inconnu doit ")
    y_position -= 30  # Espacement supplémentaire
    ...
    table = Table(
        data, colWidths=[30, 50, 80, 150, 80, 80]
    ...
    table_height = len(data) * 20  # Estimation de la hauteur (20 points par ligne)
    ...
    montant_final = prix_total - reduction + charges_connexes
    ...
    code = "123456789012"  # Code-barres (peut être dynamique)
